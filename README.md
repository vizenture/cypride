...
- [X] _Fully compliant_ with Google Play policies
- [X] _Begin_ optimization efforts to improve stability
- [ ] _Implement_ ride notifications for the dashboard
- [ ] _Add_ Language options in settings (Greek, Russian)
